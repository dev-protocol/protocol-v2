...
const handler = async function (deployer, network) {
	...
	const adminInstance = await artifacts.require('DevAdmin').at('0x00551f424BD3426A1B15eb1Ea4680cc2bf7E9D76')
	...
	const implAddress = await adminInstance.getProxyImplementation(metricsFactoryProxy)
